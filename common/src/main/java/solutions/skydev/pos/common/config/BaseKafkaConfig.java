...
/**
 * Base Kafka configuration class that provides common Kafka configuration for all services.
 * Services should extend this class and add their specific configurations if needed.
 */
public abstract class BaseKafkaConfig {
    ...
    /**
     * Creates a map of consumer configurations.
     ...
     */
    protected ConcurrentMessageListenerContainer<String, Collection<ConsumerRecord<String, Object>>> createRepliesContainers(String topic1, String topic2) {
