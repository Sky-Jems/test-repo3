...
public class DiscountController {
    ...
    public List<DiscountProductResponseDto> getDiscountProducts(@PathVariable Long id) {
        List<DiscountProduct> discount = discountService.getProductsByDiscountId(id);
        return discountProductMapper.toDto(discount);
    }
